...
public class CreateDatabase extends SQLiteOpenHelper {
    ...
    public static String TBL_MON_HINHANH = "HINHANH"; // Thay đổi từ BLOB thành TEXT
    ...
    public static String TBL_LOAIMON_HINHANH = "HINHANH"; // Thay đổi từ BLOB thành TEXT
    ...
    public void onCreate(SQLiteDatabase db) {
        String tblNHANVIEN = "CREATE TABLE " + TBL_NHANVIEN + " ( " + TBL_NHANVIEN_MANV + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                + TBL_NHANVIEN_HOTENNV + " TEXT, " + TBL_NHANVIEN_TENDN + " TEXT, " + TBL_NHANVIEN_MATKHAU + " TEXT, "
                + TBL_NHANVIEN_EMAIL + " TEXT, " + TBL_NHANVIEN_SDT + " TEXT, "
                + TBL_NHANVIEN_GIOITINH + " TEXT, " + TBL_NHANVIEN_NGAYSINH + " TEXT, " + TBL_NHANVIEN_MAQUYEN + " INTEGER)";
        ...
        String tblMON = "CREATE TABLE " + TBL_MON + " ( " + TBL_MON_MAMON + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                ...
                + TBL_MON_HINHANH + " TEXT, " + TBL_MON_MALOAI + " INTEGER )"; // Thay đổi BLOB thành TEXT

        String tblLOAIMON = "CREATE TABLE " + TBL_LOAIMON + " ( " + TBL_LOAIMON_MALOAI + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                + TBL_LOAIMON_HINHANH + " TEXT, " + TBL_LOAIMON_TENLOAI + " TEXT)"; // Thay đổi BLOB thành TEXT

        String tblDONDAT = "CREATE TABLE " + TBL_DONDAT + " ( " + TBL_DONDAT_MADONDAT + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                + TBL_DONDAT_MABAN + " INTEGER, " + TBL_DONDAT_MANV + " INTEGER, " + TBL_DONDAT_NGAYDAT + " TEXT, "
                + TBL_DONDAT_TONGTIEN + " TEXT," + TBL_DONDAT_TINHTRANG + " TEXT )";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + TBL_QUYEN);
        db.execSQL("DROP TABLE IF EXISTS " + TBL_BAN);
        db.execSQL("DROP TABLE IF EXISTS " + TBL_MON);
        db.execSQL("DROP TABLE IF EXISTS " + TBL_LOAIMON);
        db.execSQL("DROP TABLE IF EXISTS " + TBL_DONDAT);
        db.execSQL("DROP TABLE IF EXISTS " + TBL_CHITIETDONDAT);
        onCreate(db);
    }
